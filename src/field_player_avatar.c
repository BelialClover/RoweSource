...
static const u16 sPlayerAvatarGfxIdsRS[][2] =
{
...
static const u16 sPlayerAvatarGfxIdsFRLG[][2] =
{
...
static const u16 sPlayerAvatarGfxIdsBW[][2] =
{
    {OBJ_EVENT_GFX_HILBERT_NORMAL,  			OBJ_EVENT_GFX_LEAF_NORMAL},
    {OBJ_EVENT_GFX_HILBERT_MACH_BIKE,  			OBJ_EVENT_GFX_LEAF_MACH_BIKE},
    {OBJ_EVENT_GFX_HILBERT_ACRO_BIKE,  			OBJ_EVENT_GFX_LEAF_ACRO_BIKE},
    {OBJ_EVENT_GFX_HILBERT_SURFING,    			OBJ_EVENT_GFX_LEAF_SURFING},
    {OBJ_EVENT_GFX_HILBERT_UNDERWATER, 			OBJ_EVENT_GFX_LEAF_UNDERWATER},
    {OBJ_EVENT_GFX_HILBERT_FIELD_MOVE, 			OBJ_EVENT_GFX_LEAF_FIELD_MOVE},
    {OBJ_EVENT_GFX_HILBERT_FISHING,    			OBJ_EVENT_GFX_LEAF_FISHING},
    {OBJ_EVENT_GFX_HILBERT_WATERING,   			OBJ_EVENT_GFX_LEAF_WATERING},
};
...
static const u16 sPlayerAvatarGfxToStateFlagRS[2][5][2] =
{
    [MALE] =
    {
...
static const u16 sPlayerAvatarGfxToStateFlagFRLG[2][5][2] =
{
    [MALE] =
    {
...
static const u16 sPlayerAvatarGfxToStateFlagBW[2][5][2] =
{
    [MALE] =
    {
...
static u8 GetPlayerAvatarStateTransitionByGraphicsId(u16 graphicsId, u8 gender)
{
	...
	//FRLG Costume
	for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlagFRLG[0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlagFRLG[gender][i][0] == graphicsId)
            return sPlayerAvatarGfxToStateFlagFRLG[gender][i][1];
    }
	//BW Costume
	for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlagBW[0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlagBW[gender][i][0] == graphicsId)
            return sPlayerAvatarGfxToStateFlagBW[gender][i][1];
    }
...
u16 GetPlayerAvatarGraphicsIdByCurrentState(void)
{
	...
	case FRLG_COSTUME:
		for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlagFRLG[0]); i++)
		{
			if (sPlayerAvatarGfxToStateFlagFRLG[gPlayerAvatar.gender][i][1] & flags)
				return sPlayerAvatarGfxToStateFlagFRLG[gPlayerAvatar.gender][i][0];
		}
	break;
	case BW_COSTUME:
		for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlagBW[0]); i++)
		{
			if (sPlayerAvatarGfxToStateFlagBW[gPlayerAvatar.gender][i][1] & flags)
				return sPlayerAvatarGfxToStateFlagBW[gPlayerAvatar.gender][i][0];
		}
	break;
	}
