...
void ReturnToFieldOpenUIStartMenu(void)
{
    FadeInFromBlack();
	CreateTask(Task_OpenStartMenuFromStartMenu, 0x50);
    ScriptContext2_Enable();
}
...
static void Task_TeleportTileWarpExit(u8 taskId)//Task_SpinEnterWarp
{
    switch (gTasks[taskId].data[0])
    {
    case 0:
