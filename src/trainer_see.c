...
#define FLDEFF_PAL_TAG_EMOTION	0x1014
...
static const u16 gObjectEventPalette_Emotion[] = INCBIN_U16("graphics/misc/emoticons.gbapal");

const struct SpritePalette gSpritePalette_GeneralEmotionPalette = {gObjectEventPalette_Emotion, FLDEFF_PAL_TAG_EMOTION}; 
...
static const struct OamData sOamData_Icons =
{
    ...
    .tileNum = 0,
    .priority = 1,
    .paletteNum = FLDEFF_PAL_TAG_EMOTION,
    .affineParam = 0,
};
...
u8 FldEff_ExclamationMarkIcon(void)
{
    ...
    LoadSpritePalette(&gSpritePalette_GeneralEmotionPalette);
	//LoadObjectEventPalette(FLDEFF_PAL_TAG_EMOTION, TRUE);
    ...
    if (spriteId != MAX_SPRITES){
		...
		//sprite->oam.paletteNum = FLDEFF_PAL_TAG_EMOTION;
	}
