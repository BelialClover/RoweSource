...
static u32 common_mainseq_4(struct mevent_srv_common * svr)
{
    ...
    case 10:
        AGB_ASSERT(cmd->parameter == NULL);
        svr->param = MysteryGiftLinkGameData_GetValueNFrom_unk_20(svr->mevent_unk1442cc, cmd->flag);
        break;
    case 11:
        AGB_ASSERT(cmd->flag == FALSE);
        svr->param = MysteryGiftLinkGameData_CompareField_unk_16(svr->mevent_unk1442cc, cmd->parameter);
        break;
    case 12:
        AGB_ASSERT(cmd->flag == FALSE);
