...
static void SetCutGrassMetatile(s16 x, s16 y)
{
    ...
    case METATILE_General_TallGrass:
        ...
        break;
	case METATILE_General_TallGrassHole:
        MapGridSetMetatileIdAt(x, y, METATILE_General_Hole);
        break;
	case METATILE_SeviiIslands123_TallGrassHoleFRLG:
        MapGridSetMetatileIdAt(x, y, METATILE_SeviiIslands123_HoleFRLG);
        break;
