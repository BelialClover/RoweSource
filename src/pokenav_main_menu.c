...
static const struct CompressedSpriteSheet sPokenavKantoMapLeftHeaderSpriteSheet =
{
    .data = gPokenavLeftHeaderKantoMap_Gfx,
    .size = 0xC00,
    .tag = 2
};
...
static void InitHoennMapHeaderSprites(void)
{
	...
	if(gMapHeader.region == REGION_HOENN)
		...
		LoadCompressedSpriteSheet(&sPokenavKantoMapLeftHeaderSpriteSheet);
