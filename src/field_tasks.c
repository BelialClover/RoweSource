    ...
    switch (data[1])
    {
        ...
        case 2:
            ...
            else
            {
                ...
                y = data[5];
                PlaySE(SE_ICE_CRACK);
                if(gSaveBlock1Ptr->location.mapNum == MAP_NUM(FOUR_ISLAND_ICEFALL_CAVE_1F) &&
                   gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(FOUR_ISLAND_ICEFALL_CAVE_1F)){
                    MapGridSetMetatileIdAt(x, y, METATILE_SeafoamIslands_Broken_Ice);
                    CurrentMapDrawMetatileAt(x, y);
        ...
        case 3:
            ...
            else
            {
                ...
                if(gSaveBlock1Ptr->location.mapNum == MAP_NUM(FOUR_ISLAND_ICEFALL_CAVE_1F) &&
                   gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(FOUR_ISLAND_ICEFALL_CAVE_1F)){
                    MapGridSetMetatileIdAt(x, y, METATILE_SeafoamIslands_Ice_Broken);
                    CurrentMapDrawMetatileAt(x, y);
                }
                else{
