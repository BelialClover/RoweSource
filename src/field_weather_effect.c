...
// CONST
const u16 gFogWeatherPalette[] = INCBIN_U16("graphics/weather/fog_diagonal.gbapal");
...
const struct SpritePalette sFogSpritePalette = {gFogWeatherPalette, 0x1201};
...
{
    .tileTag = 0x1200,//GFXTAG_CLOUD,//
    .paletteTag = 0x1207,//0x1201,
...
static u8 UpdateShadowColor(u16 color) {
  u8 paletteNum = IndexOfSpritePaletteTag(15);//TAG_WEATHER_START
  if (paletteNum != 0xFF) {
...
{
    .tileTag = 4610,//GFXTAG_ASH,//
    .paletteTag = 0x1201,//0x1200,
...
{
    .tileTag = 0x1204,//GFXTAG_SANDSTORM,//
    .paletteTag = 0x1204,//0x1201,
