...
extern u16 gPlttBufferPlayer[];

void LoadCompressedPalette(const u32 *, u16, u16);
void LoadPlayerPaletteData(const void *dsrc, const u32 *csrc, u16 offset, u16 size);
void LoadPalette(const void *, u16, u16);
void LoadPokemonPalette(u8 r, u8 g, u8 b, const void *, u16, u16);
